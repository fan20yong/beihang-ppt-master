...
## Beihang University Templates

- **SVG deck preset**: `decks/beihang_university/` — Beihang/BUAA academic reports, group meetings, thesis defenses, laboratory introductions, and aerospace research presentations.
- **Native PPTX master assets**: `native_pptx/beihang/` — sanitized master/layout/theme-only PPTX files for native PowerPoint template reuse.
